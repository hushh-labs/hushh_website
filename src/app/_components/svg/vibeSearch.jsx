...
const VibeSearchIcon = (props) => (
    <svg width="80" height="81" viewBox="0 0 80 81" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path d="M56.5625 0.0957031H23.4375C10.4933 0.0957031 0 10.589 0 23.5332V56.6582C0 69.6024 10.4933 80.0957 23.4375 80.0957H56.5625C69.5067 80.0957 80 69.6024 80 56.6582V23.5332C80 10.589 69.5067 0.0957031 56.5625 0.0957031Z" fill="url(#paint0_linear_1212_973)" />
