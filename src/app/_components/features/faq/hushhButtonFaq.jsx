...
const faqData = {
  ...
  " About Product": [
    {
      question: "What is the Hushh Button, and how does it benefit customers and brands?",
      answer:"The Hushh Button is a powerful plugin that facilitates seamless personalization for both customers and brands. It allows customers to sync their preferences, past purchases, and sizing information with brands effortlessly, while enabling brands to access valuable data from Hushh users who opt-in for personalized product recommendations and marketing campaigns."    },
    {
      question: "How does the Hushh Button enhance data control and privacy for customers?",
      answer:"Customers have full control over their data sharing with the Hushh Button. Their brand-specific data is sent directly to their Hushh Wallet for secure storage and management, ensuring transparency and trust in data sharing practices."    },
      {
        question: "What are the key features offered to brands by the Hushh Button?",
        answer: "Brands receive an SDK for easy integration into their existing website, along with customizable UI options. They gain access to a dashboard to monitor received data analytics, request additional data from users, and provide users with Hushh Coins for data transactions"
      },
      {
        question: "How does the Hushh Button streamline data exchange and compliance for brands?",
        answer: "The Hushh Button simplifies data collection for brands and ensures compliance with user privacy preferences, reducing friction in data syncing and enhancing the overall shopping journey. "
      },
      {
        question: "What benefits do customers experience with the Hushh Button?",
        answer: "Customers receive personalized recommendations from brands based on their unique profile, along with Hushh Coins for data transactions. They gain access to a dashboard to monitor brand interest in their data, control data consent, and manage and organize their data effortlessly."
      },
      {
        question: "How does the Hushh Button facilitate onboarding for both users and brands?",
        answer: "For users, onboarding involves clicking on the Hushh Button integrated on a website, providing consent for data sharing, and seamlessly accessing the dashboard. Brands can sign up for the Hushh Button, fill in required details, integrate the SDK, and begin using the dashboard for data collection."
      }
