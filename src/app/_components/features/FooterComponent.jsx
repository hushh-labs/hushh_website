          ...
          <div className="flex flex-col text-left px-5 gap-5 justify-between w-full flex-1">
            ...
            <div className="flex flex-col gap-4 text-center mt-5">
              ...
              <div className="flex items-center justify-center gap-5 h-full">
                <button className="flex flex-1 hover:border-none justify-center px-4 py-2 gap-1.5 border border-myBorder rounded-full">
                  <AndroidIcon /> Android
                </button>
                <button className="flex flex-1 hover:border-none justify-center px-4 py-2 gap-1.5 w-max border border-myBorder rounded-full">
                  <IosIcon /> iOS
                </button>
              </div>
            </div>
